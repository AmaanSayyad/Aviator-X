...
export default function Leaderboard() {
    ...
    return (
        <div className="border border-neutral-700 h-full flex flex-col items-left gap-2 w-full min-h-[200px] max-h-[700px]">
            <span className="font-semibold text-lg pt-1 ps-4 flex flex-row items-center"><span>zAPT Leaderboard</span><Link href='https://x.com/aviatorx00' target="_blank"><InfoIcon className="h-4 opacity-50 hover:opacity-100 hover:cursor-pointer" /></Link></span>
