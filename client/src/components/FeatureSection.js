...
export default function FeatureSection() {
  return (
    <section id="feature" className="py-14 px-[126px] relative">
      ...
      <h1 className="font-display text-[32px] leading-[40px] text-center text-white">Features of Aviator-X</h1>
      <div className="grid-cols-2 grid py-11 px-20 gap-[60px] mt-14 bg-ruby rounded-3xl z-10 relative" >
        <div id="first-col">
          <div className="">
            ...
            <h1 className="text-white my-5 text-[32px] leading-[40px] font-bold">Traditional Aviator Crash Game vs Aviator-X

            </h1>
            <p className="text-white/[0.6] font-medium">Traditional online casinos often lack transparency, and players have to trust the platform's integrity without any verifiable proof of fairness. Issues like rigged games, hidden terms like bonus wager limits, and withdrawal restrictions are common, causing players to lose trust. Aviator-X leverages Aptos blockchain technology to solve these problems by providing transparent and provably fair gaming experiences.
</p>
          </div>
        </div>
        <div id="second-col" className="flex flex-col gap-5">
          <div className="border-t border-b border-[#E504983D] p-5 flex flex-col gap-3 inner-purple-shadow rounded-xl">
            ...
            <p className="text-white">Provably Fair Gameplay: Utilizing Aptos fully on-chain randomness module, Aviator-X ensures that all game outcomes are transparent and verifiably fair, giving players confidence in the integrity of the games.
...
Security is highly prioritized for newcomers in web3 gambling. Aviator-X utilizes robust security features of Aptos & Okto's wallet infrastructure to protect user assets from unauthorized access. 
</p>
          </div>
          <div className="border-t border-b border-[#E504983D] p-5 flex flex-col gap-3 inner-purple-shadow rounded-xl">
...
Seamless Cross-Chain Integration
            ...
            <p className="text-white">Managing assets across different blockchains is often hectic at user side. Aviator-X addresses this by offering seamless cross-chain integration, allowing players to transfer and manage assets between Aptos and other supported networks effortlessly using Pedra and Okto.</p>
          </div>
        </div>
      </div>
    </section>
